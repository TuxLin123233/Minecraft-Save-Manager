...
class Message:
    ...
    def __init__(self, parent_window: ctk.CTk | ctk.CTkToplevel) -> None:
        ...
        Returns:
            None
        """
        self.window: ctk.CTkToplevel = ctk.CTkToplevel(parent_window)
    ...
    def _on_confirm(self, value: bool = False) -> None:
        """确认按钮回调函数
    ...
    def info(self, title: str, text: str, font: ctk.CTkFont) -> bool:
        """消息通知框
        ...
        content = ctk.CTkLabel(self.window, text=text, font=font)
    ...
    def yes_no(self, title: str, text: str, font: ctk.CTkFont) -> bool:
        """选择框
